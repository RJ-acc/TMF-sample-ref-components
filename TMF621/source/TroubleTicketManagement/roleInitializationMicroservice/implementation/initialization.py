...
def main() -> int:
    ...
    canvas_system_role = os.getenv("CANVAS_SYSTEM_ROLE", "TroubleTicketManagementAdmin")
    payload = {
        "name": canvas_system_role,
        "roleType": canvas_system_role,
        "state": "active",
        "description": "Bootstrap role for the TMF621 Trouble Ticket Management component",
        "@type": "PartyRole",
    }
