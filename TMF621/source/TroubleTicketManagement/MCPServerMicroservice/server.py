...
from common.tickets import build_entity, resource_names
...
logger = logging.getLogger("tmf621-mcp")
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF621 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_trouble_ticket_payload",
        description="Validate a TMF621 create payload for a supported trouble-ticket resource.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_trouble_ticket_patch_payload",
        description="Validate a TMF621 patch payload for a supported trouble-ticket resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_trouble_ticket_payload",
        description="Preview the normalized TMF621 entity that would be created for a supported trouble-ticket resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
