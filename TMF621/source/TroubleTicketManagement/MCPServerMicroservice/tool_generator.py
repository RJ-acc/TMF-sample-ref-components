...
RESOURCE_HINTS = {
    "troubleticket": "TroubleTicket records customer or system-reported issues that need investigation and resolution.",
    "troubleticketspecification": "TroubleTicketSpecification defines reusable templates for trouble ticket capture and handling.",
    "hub": "The Hub resource manages event subscriptions for TMF621 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF621 operation: {method.upper()} {path}")
