...
def main() -> int:
    ...
    canvas_system_role = os.getenv("CANVAS_SYSTEM_ROLE", "ProductInventoryManagementAdmin")
    payload = {
        "name": canvas_system_role,
        "roleType": canvas_system_role,
        "state": "active",
        "description": "Bootstrap role for the TMFC005 Product Inventory Management component",
        "@type": "PartyRole",
    }
