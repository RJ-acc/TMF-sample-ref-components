...
from common.products import build_entity, resource_names
...
logger = logging.getLogger("tmf637-mcp")
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF637 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_product_payload",
        description="Validate a TMFC005 create payload for the TMF637 product resource.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_product_patch_payload",
        description="Validate a TMFC005 patch payload for the TMF637 product resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_product_payload",
        description="Preview the normalized TMFC005 entity that would be created for the TMF637 product resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
