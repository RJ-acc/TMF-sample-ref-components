...
RESOURCE_HINTS = {
    "product": "Product captures a customer-facing product instance in the inventory together with its lifecycle state and references.",
    "hub": "The Hub resource manages event subscriptions for TMF637 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF637 operation: {method.upper()} {path}")
