...
RESOURCE_HINTS = {
    "partyinteraction": "PartyInteraction captures historical interactions between a party and the enterprise across channels.",
    "hub": "The Hub resource manages event subscriptions for TMF683 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF683 operation: {method.upper()} {path}")
