...
from common.interactions import build_entity, resource_names
...
logger = logging.getLogger("tmf683-mcp")
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF683 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_party_interaction_payload",
        description="Validate a TMFC023 create payload for the TMF683 partyInteraction resource.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_party_interaction_patch_payload",
        description="Validate a TMFC023 patch payload for the TMF683 partyInteraction resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_party_interaction_payload",
        description="Preview the normalized TMFC023 entity that would be created for the TMF683 partyInteraction resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
