...
RESOURCE_DEFAULTS = {
    "partyinteraction": {
        ...
        "direction": "inbound",
        "reason": "Mock interaction",
        "status": "opened",
        "relatedChannel": [
            {
                "@type": "RelatedChannel",
                "role": "contactChannel",
                "channel": {"@type": "ChannelRef", "id": "web", "name": "Web", "@referredType": "Channel"},
            }
        ],
    },
...
def _build_mock_item(resource: str, resource_id: str, arguments: dict[str, object], path: str) -> dict[str, object]:
    ...
    item = {
        "id": resource_id,
        "href": f"/tmf-api/partyInteractionManagement/v5{collection_path}/{resource_id}",
        "creationDate": _now(),
        "lastUpdate": _now(),
...
def mock_execute(path: str, method: str, arguments: dict[str, object]) -> dict:
    ...
    note = "MOCK MODE - responses are synthetic. Set TMF683_MODE=live for real API calls."
