...
from common.interactions import ensure_seed_data, resource_collection, resource_names
from common.store import get_store
from common.validation import validate_create_payload, validate_patch_payload

app = FastAPI(title="TMFC023 Party Interaction Management Engine Service")
store = get_store()
