...
def main() -> int:
    ...
    canvas_system_role = os.getenv("CANVAS_SYSTEM_ROLE", "PartyInteractionManagementAdmin")
    payload = {
        "name": canvas_system_role,
        "roleType": canvas_system_role,
        "state": "active",
        "description": "Bootstrap role for the TMFC023 Party Interaction Management component",
        "@type": "PartyRole",
    }
