...
RESOURCE_DEFAULTS = {
    "billformat": {"@type": "BillFormat", "name": "Mock bill format", "state": "active"},
    "billpresentationmedia": {"@type": "BillPresentationMedia", "name": "Mock presentation media", "state": "active"},
    "billingaccount": {"@type": "BillingAccount", "name": "Mock billing account", "state": "active"},
    "billingcyclespecification": {
        "@type": "BillingCycleSpecification",
        "name": "Mock billing cycle",
        "state": "active",
    },
    "financialaccount": {"@type": "FinancialAccount", "name": "Mock financial account", "state": "active"},
    "partyaccount": {"@type": "PartyAccount", "name": "Mock party account", "state": "active"},
    "settlementaccount": {"@type": "SettlementAccount", "name": "Mock settlement account", "state": "active"},
...
def _build_mock_item(resource: str, resource_id: str, arguments: dict[str, object], path: str) -> dict[str, object]:
    ...
    item = {
        "id": resource_id,
        "href": f"/tmf-api/accountManagement/v5{collection_path}/{resource_id}",
        "lastUpdate": _now(),
...
def mock_execute(path: str, method: str, arguments: dict[str, object]) -> dict:
    ...
    note = "MOCK MODE - responses are synthetic. Set TMF666_MODE=live for real API calls."
