...
RESOURCE_DEFAULTS = {
    "permission": {"@type": "Permission", "description": "Mock permission"},
    "userrole": {"@type": "UserRole", "involvementRole": "MockUserRole"},
...
def _build_mock_item(resource: str, resource_id: str, arguments: dict[str, object], path: str) -> dict[str, object]:
    ...
    item = {
        "id": resource_id,
        "href": f"/tmf-api/rolesAndPermissions/v4{collection_path}/{resource_id}",
        "lastUpdate": _now(),
...
def mock_execute(path: str, method: str, arguments: dict[str, object]) -> dict:
    ...
    note = "MOCK MODE - responses are synthetic. Set TMF672_MODE=live for real API calls."
