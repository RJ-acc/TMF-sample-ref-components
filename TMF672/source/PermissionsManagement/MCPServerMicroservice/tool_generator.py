...
RESOURCE_HINTS = {
    "permission": "The Permission resource represents access granted by a granter to a user over manageable assets.",
    "userrole": "The UserRole resource groups entitlements that can be associated to manageable assets and users.",
    "hub": "The Hub resource manages event subscriptions for TMF672 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF672 operation: {method.upper()} {path}")
