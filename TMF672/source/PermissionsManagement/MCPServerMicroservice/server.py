...
from common.access import build_entity, resource_names
...
logger = logging.getLogger("tmf672-mcp")
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF672 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_permissions_payload",
        description="Validate a TMFC035 create payload for one of the TMF672 permissions resources.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_permissions_patch_payload",
        description="Validate a TMFC035 patch payload for one of the TMF672 permissions resources.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_permissions_payload",
        description="Preview the normalized TMFC035 entity that would be created for a TMF672 permissions resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
