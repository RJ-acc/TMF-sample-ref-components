...
RESOURCE_HINTS = {
    "sla": "The SLA resource captures service level objectives, rules, and related entities for a managed agreement.",
    "slaviolation": "The SLAViolation resource records breaches against a referenced SLA and service level objective.",
    "hub": "The Hub resource manages event subscriptions for TMF623 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF623 operation: {method.upper()} {path}")
