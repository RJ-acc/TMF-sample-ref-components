...
from common.sla import ensure_seed_data, resource_collection, resource_names
...
app = FastAPI(title="TMF623 SLA Management Engine Service")
store = get_store()
...
@app.post("/validate/{resource_name}/replace")
async def validate_replace(resource_name: str, payload: dict[str, Any]) -> dict[str, Any]:
    return validate_replace_payload(resource_name, payload)
