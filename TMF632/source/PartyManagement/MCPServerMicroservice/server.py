...
from common.parties import build_entity, resource_names
...
logger = logging.getLogger("tmf632-mcp")
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF632 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_party_payload",
        description="Validate a TMFC028 create payload for one of the TMF632 party resources.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_party_patch_payload",
        description="Validate a TMFC028 patch payload for one of the TMF632 party resources.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_party_payload",
        description="Preview the normalized TMFC028 entity that would be created for a TMF632 party resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
