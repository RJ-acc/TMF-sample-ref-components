...
RESOURCE_HINTS = {
    "individual": "Individual captures person-level party details such as name, contact medium, and identification.",
    "organization": "Organization captures legal-entity or business-level party details.",
    "hub": "The Hub resource manages event subscriptions for TMF632 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF632 operation: {method.upper()} {path}")
