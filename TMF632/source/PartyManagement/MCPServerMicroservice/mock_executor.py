...
RESOURCE_DEFAULTS = {
    "individual": {"@type": "Individual", "name": "Mock individual", "state": "active"},
    "organization": {"@type": "Organization", "name": "Mock organization", "state": "active"},
...
def _build_mock_item(resource: str, resource_id: str, arguments: dict[str, object], path: str) -> dict[str, object]:
    ...
    item = {
        "id": resource_id,
        "href": f"/tmf-api/partyManagement/v5{collection_path}/{resource_id}",
        "lastUpdate": _now(),
...
def mock_execute(path: str, method: str, arguments: dict[str, object]) -> dict:
    ...
    note = "MOCK MODE - responses are synthetic. Set TMF632_MODE=live for real API calls."
