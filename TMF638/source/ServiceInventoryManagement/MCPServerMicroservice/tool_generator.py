...
RESOURCE_HINTS = {
    "service": "Service captures a customer-facing or resource-facing service instance together with its lifecycle state, operating status, and references.",
    "hub": "The Hub resource manages event subscriptions for TMF638 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF638 operation: {method.upper()} {path}")
