...
from common.services import build_entity, resource_names
...
logger = logging.getLogger("tmf638-mcp")
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF638 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_service_payload",
        description="Validate a TMFC008 create payload for the TMF638 service resource.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_service_patch_payload",
        description="Validate a TMFC008 patch payload for the TMF638 service resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_service_payload",
        description="Preview the normalized TMFC008 entity that would be created for the TMF638 service resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
