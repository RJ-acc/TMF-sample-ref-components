...
RESOURCE_DEFAULTS = {
    "service": {
        "@type": "Service",
        "name": "Mock Fiber Access Service",
        "description": "Synthetic TMF638 service instance returned by the MCP mock executor.",
        "state": "active",
        "operatingStatus": "running",
        "serviceSpecification": {
            "id": "service-spec-mock",
            "name": "Mock Fiber Access CFS",
...
def _build_mock_item(resource: str, resource_id: str, arguments: dict[str, object], path: str) -> dict[str, object]:
    ...
    item = {
        "id": resource_id,
        "href": f"/tmf-api/serviceInventoryManagement/v5{collection_path}/{resource_id}",
        "serviceDate": _now(),
        "lastUpdate": _now(),
...
def mock_execute(path: str, method: str, arguments: dict[str, object]) -> dict:
    ...
    note = "MOCK MODE - responses are synthetic. Set TMF638_MODE=live for real API calls."
