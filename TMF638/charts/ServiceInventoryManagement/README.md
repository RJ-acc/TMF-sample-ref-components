...
By default, the chart advertises the MCP endpoint at `/<release>-serviceinventorymanagement/mcp` and also keeps the direct in-container `/mcp` route available for service-level checks.
