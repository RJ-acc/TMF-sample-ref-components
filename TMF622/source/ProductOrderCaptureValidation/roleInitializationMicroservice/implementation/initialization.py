...
def main() -> int:
    ...
    canvas_system_role = os.getenv("CANVAS_SYSTEM_ROLE", "ProductOrderAdmin")
    payload = {
        "name": canvas_system_role,
        "roleType": canvas_system_role,
        "state": "active",
        "description": "Bootstrap role for the TMFC002 Product Order Capture & Validation component",
        "@type": "PartyRole",
    }
