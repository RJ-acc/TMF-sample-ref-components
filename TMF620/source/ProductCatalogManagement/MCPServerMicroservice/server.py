...
from common.catalog import build_entity, resource_names
...
CUSTOM_TOOLS = [
    types.Tool(
        name="list_all_tools",
        description="List all generated TMF620 MCP tools available on this server.",
        inputSchema={"type": "object", "properties": {}},
    ),
    types.Tool(
        name="validate_product_catalog_payload",
        description="Validate a TMFC001 create payload for one of the TMF620 product catalog resources.",
        inputSchema={
            "type": "object",
    ...
    types.Tool(
        name="validate_product_catalog_patch_payload",
        description="Validate a TMFC001 patch payload for one of the TMF620 product catalog resources.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
    ...
    types.Tool(
        name="preview_product_catalog_payload",
        description="Preview the normalized TMFC001 entity that would be created for a TMF620 resource.",
        inputSchema={
            "type": "object",
            "required": ["resource_name", "payload"],
            "properties": {
