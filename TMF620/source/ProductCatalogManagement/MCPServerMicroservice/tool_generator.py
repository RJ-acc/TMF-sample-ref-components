...
RESOURCE_HINTS = {
    "productcatalog": "Product Catalog groups product-offering content into a commercial catalog structure.",
    "category": "Category organizes catalog content into browseable groupings.",
    "productoffering": "Product Offering defines the sellable commercial offer presented to buyers.",
    "productofferingprice": "Product Offering Price captures the commercial pricing terms attached to an offer.",
    "productspecification": "Product Specification describes the technical or business specification of the product.",
    "importjob": "Import Job represents a task that brings catalog content into the TMF620 domain.",
    "exportjob": "Export Job represents a task that publishes catalog content outward from the TMF620 domain.",
    "hub": "The Hub resource manages event subscriptions for TMF620 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF620 operation: {method.upper()} {path}")
