...
LIST_ID_OVERRIDES = {
    "listQueryProductRecommendation": "list_query_product_recommendation",
}

RESOURCE_HINTS = {
    "queryproductrecommendation": "Recommendation API captures a recommendation query and returns ranked recommendation items.",
    "hub": "The Hub resource manages event subscriptions for TMF680 notifications.",
}
...
def generate_tools(spec: dict) -> dict[str, dict]:
    ...
    for path, path_item in spec.get("paths", {}).items():
        ...
        for method, operation in path_item.items():
            ...
            description_parts.append(f"TMF680 operation: {method.upper()} {path}")
