        ...
        "recommendationItem": [
            {
                "id": "offer-5g-premium",
                "priority": 1,
                "productOffering": {"id": "offer-5g-premium", "name": "5G Premium Unlimited"},
            }
        ],
    },
    "hub": {
...
def _build_mock_item(resource: str, resource_id: str, arguments: dict[str, Any], base_path: str) -> dict[str, Any]:
    ...
    item = {
        "id": resource_id,
        "href": f"/tmf-api/recommendationManagement/v4{collection_path}/{resource_id}",
        "lastUpdate": _now(),
...
def mock_execute(path: str, method: str, arguments: dict[str, Any]) -> dict:
    ...
    note = "MOCK MODE - responses are synthetic. Set TMF680_MODE=live for real API calls."
